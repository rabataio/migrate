...
func (g *Gitlab) ReadUp(version uint) (r io.ReadCloser, f source.Func, identifier string, err error) {
...
func (g *Gitlab) ReadDown(version uint) (r io.ReadCloser, f source.Func, identifier string, err error) {
