...
func (b *Bindata) ReadUp(version uint) (r io.ReadCloser, f source.Func, identifier string, err error) {
...
func (b *Bindata) ReadDown(version uint) (r io.ReadCloser, f source.Func, identifier string, err error) {
