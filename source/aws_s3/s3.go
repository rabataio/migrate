...
func (s *s3Driver) ReadUp(version uint) (io.ReadCloser, source.Func, string, error) {
...
func (s *s3Driver) ReadDown(version uint) (io.ReadCloser, source.Func, string, error) {
...
func (s *s3Driver) open(m *source.Migration) (io.ReadCloser, source.Func, string, error) {
