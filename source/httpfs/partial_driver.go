...
func (p *PartialDriver) ReadUp(version uint) (r io.ReadCloser, f source.Func, identifier string, err error) {
...
func (p *PartialDriver) ReadDown(version uint) (r io.ReadCloser, f source.Func, identifier string, err error) {
