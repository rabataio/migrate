...
func (g *Github) ReadUp(version uint) (r io.ReadCloser, f source.Func, identifier string, err error) {
	g.ensureFields()
...
func (g *Github) ReadDown(version uint) (r io.ReadCloser, f source.Func, identifier string, err error) {
	g.ensureFields()
