...
func (s *Stub) ReadUp(version uint) (r io.ReadCloser, f source.Func, identifier string, err error) {
...
func (s *Stub) ReadDown(version uint) (r io.ReadCloser, f source.Func, identifier string, err error) {
