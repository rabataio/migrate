...
func (d *PartialDriver) ReadUp(version uint) (r io.ReadCloser, f source.Func, identifier string, err error) {
...
func (d *PartialDriver) ReadDown(version uint) (r io.ReadCloser, f source.Func, identifier string, err error) {
