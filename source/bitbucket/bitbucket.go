...
func (b *Bitbucket) ReadUp(version uint) (r io.ReadCloser, f source.Func, identifier string, err error) {
	b.ensureFields()
...
func (b *Bitbucket) ReadDown(version uint) (r io.ReadCloser, f source.Func, identifier string, err error) {
	b.ensureFields()
